...
def products(request):
    try:
        ...
        try:
            ...
            return render(request, 'store/error.html', {"reason":"分类不存在"})
...
def tags(request):
    try:
        ...
        try:
            ...
            return render(request, 'store/error.html', {"reason":"标签不存在"})
...
def detail(request):
    try:
        ...
        try:
            ...
            return render(request, 'store/error.html', {"reason": "商品不存在"})
    except Exception as e:
        logger.error(e)
...
def brands(request):
    try:
        ...
        try:
            ...
            return render(request, 'store/error.html', {"reason":"品牌不存在"})
    ...
    try:
        if request.method == 'POST':
            ...
            if reg_form.is_valid():
                ...
                return render(request, 'store/error.html',{'reason': reg_form.errors})
        else:
            reg_form = RegForm()
    except Exception as e:
        logger.error(e)
        ...
        if request.method == 'POST':
            ...
            if login_form.is_valid():
                ...
                if user is not None:
                    ...
                    return render(request, 'store/error.html',{'reason': '登录验证失败'})
                return redirect(request.POST.get('source_url'))
            else:
                return render(request, 'store/error.html', {'reason': login_form.errors})
        else:
            login_form = LoginForm()
    except Exception as e:
        logger.error(e)
